				...
				<div class="container">
							...
							<ul class="slide-area">
								...
								<li class="px-3">
									...
									<a href="articulos.html" class="text-secondary">
										...
										<img src="vistas/img/articulos/articulo-01/articulo01.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
					...
					<div class="row opiniones">
						...
						<div class="col-9 col-sm-8 col-lg-10 p-2 text-muted">
							...
							<span class="small float-right">AB Travel | 20.09.2018</span>
